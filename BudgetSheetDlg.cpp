...
void CBudgetSheetDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_RADIO_EXPENSES, m_button[0]);
	DDX_Control(pDX, IDC_RADIO_REVENUES, m_button[1]);
	DDX_Control(pDX, IDC_RADIO_ARENA, m_button[2]);
	DDX_Control(pDX, IDC_RADIO_CITY, m_button[3]);
...
void CBudgetSheetDlg::SetColumnHeadersRevenues()
{
	...
	m_list_ctrl.SetColumnWidth(0, 108);
	m_list_ctrl.SetColumnWidth(1, 59);
	m_list_ctrl.SetColumnWidth(2, 65);
	m_list_ctrl.SetColumnWidth(3, 65);
	m_list_ctrl.SetColumnWidth(4, 65);
	m_list_ctrl.SetColumnWidth(5, 65);
	m_list_ctrl.SetColumnWidth(6, 65);
	m_list_ctrl.SetColumnWidth(7, 65);
	m_list_ctrl.SetColumnWidth(8, 65);
	m_list_ctrl.SetColumnWidth(9, 65);
	m_list_ctrl.SetColumnWidth(10, 59);
	m_list_ctrl.SetColumnWidth(11, 65);
	m_list_ctrl.SetColumnWidth(12, 65);
	m_list_ctrl.SetColumnWidth(13, 65);
	m_list_ctrl.SetColumnWidth(14, 65);
...
void CBudgetSheetDlg::SetColumnHeadersCity()
{
	...
	m_list_ctrl.SetColumnWidth(2, 120);
	m_list_ctrl.SetColumnWidth(3, 120);
	m_list_ctrl.SetColumnWidth(4, 120);
	m_list_ctrl.SetColumnWidth(5, 120);
	m_list_ctrl.SetColumnWidth(6, 120);
	m_list_ctrl.SetColumnWidth(7, 120);
...
void CBudgetSheetDlg::SetColumnHeaders()
{
	...
	m_list_ctrl.SetColumnWidth(8, 90);
	m_list_ctrl.SetColumnWidth(9, 90);
...
void CBudgetSheetDlg::SetColumnHeadersArena()
{
	...
	m_list_ctrl.SetColumnWidth(0, 120);
	m_list_ctrl.SetColumnWidth(1, 72);
	m_list_ctrl.SetColumnWidth(2, 72);
	m_list_ctrl.SetColumnWidth(3, 72);
	m_list_ctrl.SetColumnWidth(4, 72);
	m_list_ctrl.SetColumnWidth(5, 72);
	m_list_ctrl.SetColumnWidth(6, 72);
	m_list_ctrl.SetColumnWidth(7, 72);
	m_list_ctrl.SetColumnWidth(8, 72);
	m_list_ctrl.SetColumnWidth(9, 72);
	m_list_ctrl.SetColumnWidth(10, 72);
	m_list_ctrl.SetColumnWidth(11, 72);
	m_list_ctrl.SetColumnWidth(12, 72);
...
void CBudgetSheetDlg::SetListBoxHeaders()
{
	...
	m_list_stats.SetColumnWidth(0, 140);
	m_list_stats.SetColumnWidth(1, 100);
	m_list_stats.SetColumnWidth(2, 100);
...
void CBudgetSheetDlg::ListDataArena()
{
	...
	for (int index = 0; index < m_number_teams; index++)
	{
		...
		pct = 0;
		if(fin.m_suites > 0) pct = int((double)fin.m_season_suites_sold / ((double)fin.m_suites * g) * 1000);
		r = (double)pct / 10;
		Stats[6].Format("%.2f", r);
		...
		pct = 0;
		if(fin.m_club_seats > 0) pct = int((double)fin.m_season_clubs_sold / ((double)fin.m_club_seats * g) * 1000);
		r = (double)pct / 10;
		Stats[9].Format("%.2f", r);
		...
		if (fin.m_parking == 0 || fin.m_parking_spots == 0) pct = 0;
		else pct = int((double)fin.m_season_parking_revenue / (double)fin.m_parking / ((double)fin.m_parking_spots * g) * 1000);
		r = (double)pct / 10;
		Stats[12].Format("%.2f", r);
...
void CBudgetSheetDlg::SortArenas()
{
	...
	for (int i = 0; i < m_number_teams; i++)
	{
		for (int j = 0; j < m_number_teams; j++)
		{
			...
			double f_i = (double)m_i.m_suites;
			double f_j = (double)m_j.m_suites;
			if(f_i > 0) f_i = (double)m_i.m_season_suites_sold / ((double)m_i.m_suites * g_i);
			if(f_j > 0) f_j = (double)m_j.m_season_suites_sold / ((double)m_j.m_suites * g_j);

			double cl_i = (double)m_i.m_club_seats;
			double cl_j = (double)m_j.m_club_seats;

			if(cl_i > 0) cl_i = (double)m_i.m_season_clubs_sold / ((double)m_i.m_club_seats * g_i);
			if(cl_j > 0) cl_j = (double)m_j.m_season_clubs_sold / ((double)m_j.m_club_seats * g_j);
			
			double pk_i = 0;
			if ((double)m_i.m_parking > 0 && (double)m_i.m_parking_spots > 0)
			{
				pk_i = (double)m_i.m_season_parking_revenue / (double)m_i.m_parking / ((double)m_i.m_parking_spots * g_i);
			}

			double pk_j = 0;
			if ((double)m_j.m_parking > 0 && (double)m_j.m_parking_spots > 0)
			{
				pk_j = (double)m_j.m_season_parking_revenue / (double)m_j.m_parking / ((double)m_j.m_parking_spots * g_j);
			}
