...
COwnerDrawComboBox::COwnerDrawComboBox()
{
	...
	// COwnerDrawComboBox as implemented here.
}
...
int COwnerDrawComboBox::CompareItem(LPCOMPAREITEMSTRUCT lpCompareItemStruct)
{
...
void COwnerDrawComboBox::AddListItem(COLORREF color)
{
...
void COwnerDrawComboBox::LoadList()
{
