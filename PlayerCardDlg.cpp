...
void CPlayerCardDlg::Player() 
{
	...
	CString img = avg.m_settings.m_path + "Pictures\\" + na + ".bmp";
...
//    m_listctrlstats.SetColumnWidth( 1, 40);
    ...
    m_list_ctrl_1.SetColumnWidth( 0, 56);
    m_list_ctrl_1.SetColumnWidth( 1, 74);

	m_list_ctrl_2.DeleteAllItems();
    m_list_ctrl_2.InsertColumn(0,"");    
    m_list_ctrl_2.InsertColumn(1,"salary");    
    m_list_ctrl_2.SetColumnWidth( 0, 63);
    m_list_ctrl_2.SetColumnWidth( 1, 63);

	m_list_ctrl_3.DeleteAllItems();
    m_list_ctrl_3.InsertColumn(0,"");    
    m_list_ctrl_3.InsertColumn(1,"status");    
    m_list_ctrl_3.SetColumnWidth( 0, 64);
    m_list_ctrl_3.SetColumnWidth( 1, 70);
